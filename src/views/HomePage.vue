    ...
    <ion-content :fullscreen="true">
      <ion-header class="ion-padding-horizontal ion-padding-top ion-no-border">
        <ion-grid>
          <ion-row>
            <ion-col>
              <div id="counterText" class="ion-text-start">
                Your Score: {{ score }}
              </div>
            </ion-col>
            <ion-col>
              <div id="timerText" class="ion-text-end">
                Time Left: {{ timeLeft }}
              </div>
            </ion-col>
          </ion-row>
      ...
      <div id="container">
        <ion-button id="tapMeButton" color="primary" fill="solid" @click="tap">Apreta'm</ion-button>
      </div>
    </ion-content>
  </ion-page>
</template>
